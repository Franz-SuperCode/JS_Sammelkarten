...
class Pokemon {
    ...
    writeHTML() {
        ...
        let allPropertys = `${this.name} - ${this.weight} Kg - ${this.catchDate} - ${this.attacks} <br>`;
        ...
        liEl.innerHTML = `Name: ${this.name} 
        <br> Gewicht: ${this.weight} Kg
        <br>Fangdatum: ${this.catchDate} 
       <br> Attacken: ${this.attacks}`,
            // liEl.style.backgroundImage = `url("${imgInput.value}")`;
            liEl.innerHTML += `<img src="${imgInput.value}" alt="pokemon">`
